...
def main():
    ...
    for run in range(0, cnt):
        ...
        temp = tuple([int(0.2*len(dataset)), int(0.1*len(dataset)), len(dataset) - int(0.2*len(dataset)) - int(0.1*len(dataset))])
        ...
        temp = [int(0.4*len(dataset)), len(dataset_logits_test) - int(0.4*len(dataset))]
